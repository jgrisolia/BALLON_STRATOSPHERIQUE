...
#define BARGRAPH 1500    // 1500 cpm by default
...
#define PWM_FUL 110       // pwm settings for different battery levels 
#define PWM_MID 115
#define PWM_LOW 120
...
#define FACTOR_USV 0.0082    // Le miens SI-29BG
/*
SBM-20   0.0057
SBM-19   0.0021
SI-29BG  0.0082
...
//#define DOSE_LIMIT 99       // Maximum allowed absorbed value in uSV
                            // be sure it can be written to 5 lcd characters ""00.00"
...
prog_char string_3[]  PROGMEM = "SD FILE ERROR   ";  
prog_char string_4[]  PROGMEM = "STARTING SD CARD";  
prog_char string_5[]  PROGMEM = "LOG TO          ";  
